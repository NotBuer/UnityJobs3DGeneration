...
public static class VoxelMeshUtils
{
    ...
    public static void SetVoxelMeshData(Vector3 position, ref Mesh.MeshData meshData)
    {
        ...
        var p4 = new Vector3(-0.5f,  0.5f,  0.5f) + position; // Front top-left
        var p5 = new Vector3( 0.5f,  0.5f,  0.5f) + position; // Front top-right
        var p6 = new Vector3( 0.5f,  0.5f, -0.5f) + position; // Back top-right
        var p7 = new Vector3(-0.5f,  0.5f, -0.5f) + position; // Back top-left
